# Implementating quantum Prisoner's Dilemma with Qiskit
...
On a related note, calculating Nash equilibrium can be computationally intensive for large games (many players with many strategies). To mitigate this, quantum computers can be used to accelarate its calculation, for example, here: https://github.com/DarkStarQuantumLab/NashEquilibrium. 
